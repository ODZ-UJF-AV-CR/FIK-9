...
\bibitem{Timepix} Urbar J., Scheirich J., Jakubek J. {\it Medipix/Timepix cosmic ray tracking on BEXUS stratospheric balloon flights.} Nucl. Instrum. Methods. Phys. Res. A {\bf 633}, 206-209 (2011). 

\bibitem{cosmic_ray_intensity} Sarkar R., Chakrabarti S. K., Sarathi Pal P., Bhowmick D., Bhattacharya A. {\it Measurement of secondary cosmic ray intensity at Regener-Pfotzer height using low-cost weather balloons and its correlation with solar activity.} Adv. Space Res. {\bf 60}, 991–998 (2017). 

\bibitem{Radioactivity_atmosphere} Li S.W., Li Y.S., Tsui K.C. {\it Radioactivity in the atmosphere over Hong Kong.} J. Environ. Radioact. {\bf 94}, 98-106 (2007). 
	
\bibitem{ionization_profile} Yaniv R., Yair Y., Price C., Nicoll K., Harrison G., Artamonov A., Usoskin I. {\it Balloon measurements of the vertical ionization profile over southern Israel and comparison to mid-latitude observations.} J. Atmosph. and Solar–Terrestr. Phys. {\bf 149}, 87–92 (2016). 

\bibitem{Vertical_profile_measurements} Harrison R.G., Nicoll K.A., Aplin K.L. {\it Vertical profile measurements of lower troposphere ionisation.} J. Atmosph. and Solar–Terrestr. Phys. {\bf 119}, 203–210 (2014). 

...
{\begin{tabular}{p{0.22\columnwidth} >{\centering\arraybackslash}p{0.15\columnwidth} p{0.15\columnwidth} >{\centering\arraybackslash}p{0.15\columnwidth} p{0.1\columnwidth}}

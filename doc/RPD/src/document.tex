...
\bibitem{Lawrence} Lawrence et al. {\it Near-space operation of compact CsI, CLYC, and CeBr sensors: Results from two high-altitude balloon flights.} Nuclear Instruments and Methods in Physics Research A {\bf 905}, 33-46 (2018).
...
\bibitem{Mukherjee} B. Mukherjee, X. Wu, Maczka T., Kwan T., Huang Y., Mares V. {\it Near space radiation dosimetry in Australian outback using a balloon borne energy compensated PIN diode detector.} Radiation Measurements {\bf 94}, 65-72 (2016). 

\bibitem{Timepix} J. Urbar, Scheirich J., Jakubek J. {\it Medipix/Timepix cosmic ray tracking on BEXUS stratospheric balloon flights.} Nuclear Instruments and Methods in Physics Research A {\bf 633}, 206-209 (2011). 

\bibitem{cosmic_ray_intensity} R. Sarkar, Chakrabarti S. K., Sarathi Pal P., Bhowmick D., Bhattacharya A. {\it Measurement of secondary cosmic ray intensity at Regener-Pfotzer height using low-cost weather balloons and its correlation with solar activity.} Advances in Space Research {\bf 60}, 991–998 (2017). 

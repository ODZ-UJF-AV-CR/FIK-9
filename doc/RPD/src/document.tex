...
\bibitem{Pfotzer} Pfotzer, G. {\it Dreifachkoinzidenzen der Ultrastrahlung aus vertikaler Richtung in der Stratosphäre.} Zeitschrift für Physik 102(1-2), 41-58 (1936).

\bibitem{Lawrence} Lawrence et al. {\it Near-space operation of compact CsI, CLYC, and CeBr sensors: Results from two high-altitude balloon flights.} Nuclear Instruments and Methods in Physics Research A 905, 33-46 (2018).
...
\bibitem{Mukherjee} B. Mukherjee, X. Wu, Maczka T., Kwan T., Huang Y., Mares V. {\it Near space radiation dosimetry in Australian outback using a balloon borne energy compensated PIN diode detector.} Radiation Measurements 94, 65-72 (2016). 

\bibitem{Timepix} J. Urbar, Scheirich J., Jakubek J. {\it Medipix/Timepix cosmic ray tracking on BEXUS stratospheric balloon flights.} Nuclear Instruments and Methods in Physics Research A 633, 206-209 (2011). 

\bibitem{cosmic_ray_intensity} R. Sarkar, Chakrabarti S. K., Sarathi Pal P., Bhowmick D., Bhattacharya A. {\it Measurement of secondary cosmic ray intensity at Regener-Pfotzer height using low-cost weather balloons and its correlation with solar activity.} Advances in Space Research 60, 991–998 (2017). 

\bibitem{Radioactivity_atmosphere} Li S.W., Li Y.S., Tsui K.C. {\it Radioactivity in the atmosphere over Hong Kong.} Journal of Environmental Radioactivity 94, 98-106 (2007). 
	
\bibitem{ionization_profile} Yaniv R., Yair Y., Price C., Nicoll K., Harrison G., Artamonov A., Usoskin I. {\it Balloon measurements of the vertical ionization profile over southern Israel and comparison to mid-latitude observations.} Journal of Atmospheric and Solar–Terrestrial Physics 149, 87–92 (2016). 

\bibitem{Vertical_profile_measurements} Harrison R.G., Nicoll K.A., Aplin K.L. {\it Vertical profile measurements of lower troposphere ionisation.} Journal of Atmospheric and Solar-Terrestrial Physics 119, 203–210 (2014). 

\bibitem{Regener} Regener, E. {\it New results in cosmic ray measurements.} Nature 132, 696–698 (1933).

\bibitem{cosmic_ultra-radiation} Regener, E., Pfotzer, G. {\it Intensity of the cosmic ultra-radiation in the stratosphere with the tube-counter.} Nature 134, 325 (1935).

\bibitem{SPACEDOS} Kákona, M., Ambrožová, I., Inozemtsev, K. O., Ploc, O., Tolochek, R. V., Sihver, L., … Shurshakov, V. A. {\it SPACEDOS – an open-source PIN diode dosimeter for applications in Space.} (2021).

\bibitem{AIRDOS-C} Velychko, O., Kákona, M., Ambrožová, I., and Ploc, O. {\it Characterisation of AIRDOS-C detector for measurement of high-energy events in the atmosphere.} (2021).

\bibitem{standard_atmosphere} NOAA, United States Air Force. U.S. Standard Atmosphere. Washington, DC (1976).

\bibitem{confidence_intervals} Olsson, U. {\it Confidence intervals for the mean of a log-normal distribution.} Journal of Statistics Education, 13(1) (2005).

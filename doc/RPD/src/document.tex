...
\bibitem{Pfotzer} Pfotzer, G. (1936). {\it Dreifachkoinzidenzen der Ultrastrahlung aus vertikaler Richtung in der Stratosphäre.} Zeitschrift für Physik, 102(1-2), 41-58.

\bibitem{Lawrence} Lawrence et al., 2018. {\it Near-space operation of compact CsI, CLYC, and CeBr sensors: Results from two high-altitude balloon flights.} Nuclear Instruments and Methods in Physics Research A 905, 2018, 33-46.

\bibitem{Bazilevskaya} Bazilevskaya, G. A., and A. K. Svirzhevskaya (1998), {\it On the stratospheric measurements of cosmic rays.} Space Sci. Rev., 85, 431–521.
\bibitem{Mukherjee} B. Mukherjee, X. Wu, T. Maczka, T. Kwan, Y. Huang, V. Mares. {\it Near space radiation dosimetry in Australian outback using a balloon borne energy compensated PIN diode detector.} Radiation Measurements 94, 2016, 65-72. 

\bibitem{Timepix} J. Urbar, J.Scheirich, J.Jakubek. {\it Medipix/Timepix cosmic ray tracking on BEXUS stratospheric balloon flights.} Nuclear Instruments and Methods in Physics Research A 633 (2011), S206–S209. 

\bibitem{cosmic_ray_intensity} R. Sarkar, S. K. Chakrabarti, P. Sarathi Pal, D. Bhowmick, A. Bhattacharya. {\it Measurement of secondary cosmic ray intensity at Regener-Pfotzer height using low-cost weather balloons and its correlation with solar activity.} Advances in Space Research 60 (2017) 991–998. 

\bibitem{Radioactivity_atmosphere} S.W. Li, Y.S. Li, K.C. Tsui. {\it Radioactivity in the atmosphere over Hong Kong.} Journal of Environmental Radioactivity 94 (2007) 98-106. 
	
\bibitem{ionization_profile} R. Yaniv, Y. Yair, C. Price, K. Nicoll, G. Harrison, A. Artamonov, I. Usoskin. {\it Balloon measurements of the vertical ionization profile over southern Israel and comparison to mid-latitude observations.} Journal of Atmospheric and Solar–Terrestrial Physics 149 (2016) 87–92. 

\bibitem{Vertical_profile_measurements} R.G. Harrison, K.A. Nicoll, K.L. Aplin. {\it Vertical profile measurements of lower troposphere ionisation.} Journal of Atmospheric and Solar-Terrestrial Physics 119 (2014), 203–210. 

\bibitem{Regener} Regener, E., 1933. {\it New results in cosmic ray measurements.} Nature 132, 696–698.

\bibitem{cosmic_ultra-radiation} Regener, E., Pfotzer, G., 1935. {\it Intensity of the cosmic ultra-radiation in the stratosphere with the tube-counter.} Nature 134, 325.

\bibitem{SPACEDOS} Kákona, M., Ambrožová, I., Inozemtsev, K. O., Ploc, O., Tolochek, R. V., Sihver, L., … Shurshakov, V. A. (2021). {\it SPACEDOS – an open-source PIN diode dosimeter for applications in Space.}

\bibitem{AIRDOS-C} Velychko, O., Kákona, M., Ambrožová, I., and Ploc, O. (2021). {\itCharacterisation of AIRDOS-C detector for measurement of high-energy events in the atmosphere.}

\bibitem{standard_atmosphere} NOAA, United States Air Force. (1976). U.S. Standard Atmosphere. Washington, DC.

\bibitem{confidence_intervals} Olsson, U. (2005). {\it Confidence intervals for the mean of a log-normal distribution} Journal of Statistics Education, 13(1).

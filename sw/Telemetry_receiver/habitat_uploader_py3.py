...
def start_lora_rx(qu):
    app_id = "balloons-of-odz-ujf-av-cr"
    access_key = "ttn-account-v2.uivhudXhF88I7o75YmRL3AlQQoamlx7GXPUCp3zr-cQ"
        ...
        try:
            ...
            for x in range(0,4):
                try:
                    ...
                    body = bytes(json.dumps(make_data(sentence, callsign)), encoding="ascii")
